...
using Self = Nomnom.Utilities.Math.Bits.Bit8;
using InternalType = System.SByte;
...
namespace Nomnom.Utilities.Math.Bits {
	public class Bit8 {
		...
		public Bit8(InternalType baseValue) {
			_value = baseValue;
		}

		public Bit8(Enum enumValue) {
		...
		public string ToBitString() {
			return BitUtility.Bit8ToString(_value);
		}
