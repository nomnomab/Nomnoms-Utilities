...
using Self = Nomnom.Utilities.Math.Bits.Bit16;
using InternalType = System.Int16;
...
namespace Nomnom.Utilities.Math.Bits {
	public class Bit16 {
		...
		public Bit16(InternalType baseValue) {
			_value = baseValue;
		}

		public Bit16(Enum enumValue) {
			_value = Convert.ToInt16(enumValue);
		}
		...
		public string ToBitString() {
			return BitUtility.Bit16ToString(_value);
		}
